...
!function setClock() {
    ...
    function myTime() {
        const obj = {};
        const options = { timeZone: 'Europe/Paris', hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: false, day: 'numeric', month: 'numeric', year: 'numeric' };
...
!function lanyard() {
    ...
    ws.addEventListener('open', () => ws.send(JSON.stringify({ op: 2, d: { subscribe_to_id: '947204756898713721' } })));
